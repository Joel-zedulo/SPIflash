...
// Combinatorial Logic
//------------------------------------------------------------------------------
assign mgmtsoc_vexriscv = cpu_reset_vector;
...
//EDIT: Switch to mono-directional I/0 lines
//assign flash_dq = inferredsdrtristate_oe ? inferredsdrtristate__o : 4'bz;
//assign inferredsdrtristate = flash_dq;

assign inferredsdrtristate = {flash_io3_di, flash_io2_di, flash_io1_di, flash_io0_di};
assign {flash_io3_oeb, flash_io2_oeb, flash_io1_oeb, flash_io0_oeb} = {{3{inferredsdrtristate_oe[1]}}, inferredsdrtristate_oe};
assign {flash_io3_do, flash_io2_do, flash_io1_do, flash_io0_do}     = (!inferredsdrtristate_oe[1]) ? inferredsdrtristate__o : 4'bz;

//EDIT END: Switch to mono-directional I/0 lines

endmodule

// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2026-07-23 19:59:54.
//------------------------------------------------------------------------------
