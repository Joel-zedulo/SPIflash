...
// EDIT: named a block to sidestep quartus 'analysis & synthesis' error
    generate
	for (i = 2; i < `MPRJ_IO_PADS-3; i = i + 1) begin : gpio_output_en_cfg
...
// EDIT: Modified the driving logic for gpio_configure, to respect member buffer size
            	    8'h1d: begin
//			gpio_configure[0][12:8] <= cdata[4:0];
			gpio_configure[0][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h1e: begin
...
//			gpio_configure[1][12:8] <= cdata[4:0];
			gpio_configure[1][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h20: begin
...
//			gpio_configure[2][12:8] <= cdata[4:0];
			gpio_configure[2][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h22: begin
...
//			gpio_configure[3][12:8] <= cdata[4:0];
			gpio_configure[3][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h24: begin
...
//			gpio_configure[4][12:8] <= cdata[4:0];
			gpio_configure[4][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h26: begin
...
//			gpio_configure[5][12:8] <= cdata[4:0];
			gpio_configure[5][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h28: begin
...
//			gpio_configure[6][12:8] <= cdata[4:0];
			gpio_configure[6][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h2a: begin
...
//			gpio_configure[7][12:8] <= cdata[4:0];
			gpio_configure[7][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h2c: begin
...
//			gpio_configure[8][12:8] <= cdata[4:0];
			gpio_configure[8][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h2e: begin
...
//			gpio_configure[9][12:8] <= cdata[4:0];
			gpio_configure[9][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h30: begin
...
//			gpio_configure[10][12:8] <= cdata[4:0];
			gpio_configure[10][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h32: begin
...
//			gpio_configure[11][12:8] <= cdata[4:0];
			gpio_configure[11][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h34: begin
...
//			gpio_configure[12][12:8] <= cdata[4:0];
			gpio_configure[12][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h36: begin
...
//			gpio_configure[13][12:8] <= cdata[4:0];
			gpio_configure[13][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h38: begin
...
//			gpio_configure[14][12:8] <= cdata[4:0];
			gpio_configure[14][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h3a: begin
...
//			gpio_configure[15][12:8] <= cdata[4:0];
			gpio_configure[15][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h3c: begin
...
//			gpio_configure[16][12:8] <= cdata[4:0];
			gpio_configure[16][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h3e: begin
...
//			gpio_configure[17][12:8] <= cdata[4:0];
			gpio_configure[17][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h40: begin
...
//			gpio_configure[18][12:8] <= cdata[4:0];
			gpio_configure[18][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h42: begin
...
//			gpio_configure[19][12:8] <= cdata[4:0];
			gpio_configure[19][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h44: begin
...
//			gpio_configure[20][12:8] <= cdata[4:0];
			gpio_configure[20][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h46: begin
...
//			gpio_configure[21][12:8] <= cdata[4:0];
			gpio_configure[21][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h48: begin
...
//			gpio_configure[22][12:8] <= cdata[4:0];
			gpio_configure[22][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h4a: begin
...
//			gpio_configure[23][12:8] <= cdata[4:0];
			gpio_configure[23][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h4c: begin
...
//			gpio_configure[24][12:8] <= cdata[4:0];
			gpio_configure[24][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h4e: begin
...
//			gpio_configure[25][12:8] <= cdata[4:0];
			gpio_configure[25][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h50: begin
...
//			gpio_configure[26][12:8] <= cdata[4:0];
			gpio_configure[26][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h52: begin
...
//			gpio_configure[27][12:8] <= cdata[4:0];
			gpio_configure[27][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h54: begin
...
//			gpio_configure[28][12:8] <= cdata[4:0];
			gpio_configure[28][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h56: begin
...
//			gpio_configure[29][12:8] <= cdata[4:0];
			gpio_configure[29][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h58: begin
...
//			gpio_configure[30][12:8] <= cdata[4:0];
			gpio_configure[30][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h5a: begin
...
//			gpio_configure[31][12:8] <= cdata[4:0];
			gpio_configure[31][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h5c: begin
...
//			gpio_configure[32][12:8] <= cdata[4:0];
			gpio_configure[32][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h5e: begin
...
//			gpio_configure[33][12:8] <= cdata[4:0];
			gpio_configure[33][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h60: begin
...
//			gpio_configure[34][12:8] <= cdata[4:0];
			gpio_configure[34][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h62: begin
...
//			gpio_configure[35][12:8] <= cdata[4:0];
			gpio_configure[35][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h64: begin
...
//			gpio_configure[36][12:8] <= cdata[4:0];
			gpio_configure[36][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h66: begin
...
//			gpio_configure[37][12:8] <= cdata[4:0];
			gpio_configure[37][IO_CTRL_BITS-1:8] <= cdata[0+: IO_CTRL_BITS-8];
	    	    end
            	    8'h68: begin
			gpio_configure[37][7:0] <= cdata;
	    	    end
// EDIT END: I reasoned that since gpio_configure was created with 10 bits, the subsequnt illegal [12:8]
// access was a very slight mistake.
	    	    8'h69: begin
