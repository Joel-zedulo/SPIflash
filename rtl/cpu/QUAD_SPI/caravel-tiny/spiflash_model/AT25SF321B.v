// *============================================================================================== 
// *
// *   AT25SF321B.v - 32M-BIT CMOS Serial Flash Memory
// *
// *----------------------------------------------------------------------------------------------
// * Environment  : Cadence NC-Verilog
// * Reference Doc: AT25SF321B REV.1.0,May.8,2020
// * Creation Date: @(#)$Date: 2020/5/8 11:41:36 $
// * Version      : @(#)$Revision: 1.0 $
// * Description  : There is only one module in this file
// *                module AT25SF321B->behavior model for the 32M-Bit flash
// *----------------------------------------------------------------------------------------------
...
// *============================================================================================== 
    ...
    /*----------------------------------------------------------------------*/
        `define CELL_DATA          "../../caravel_sw/gpio_high.hex" // "empty"      // Flash data file name for normal array
...
module AT25SF321B(
    ...
    /*----------------------------------------------------------------------*/
    parameter     ADDR_MSB                 = 21,        
                  TOP_Add                  = 22'h3fffff,
                  Secur_TOP_Add            = 14'h3fff,
                  Secur_MSB                = 13,
                  ADDR_MSB_OTP             = 13,        
                  Sector_MSB               = 9,
                  Buffer_Num               = 256,     
    ...
    parameter  tSHQZ     = 6,                           // CS_N High to SO Float Time [ns]
               ...
               tCE       = 15_000,                      // unit is ms instead of ns  [type]
    ...
    task write_status;
        ...
        begin
            ...
            else if (WRSR3_Mode == 1'b1) begin    
                Status_Reg[0]   = 1'b1;
                #tWRSR;
                Status_Reg_3[6:5] = Status_Reg_Up[6:5];
                        ...
                        if(TB==1'b0) begin
                            if(BE64K_Mode == 1)begin                                          
                                ...
                                case({BP2,BP1,BP0})
                                    3'b000:write_protect = 1'b0;
                                    3'b001:
                                        if((Address[15:12]==4'hf || (Address[15] == 1'b1 && BE32K_Mode == 1)) && Block[Block_MSB:0]==63)
                                            write_protect = 1'b1;
                                        else
                                            write_protect = 1'b0;
                                    3'b010:
                                        if((Address[15:12]>=4'he || (Address[15] == 1'b1 && BE32K_Mode == 1)) && Block[Block_MSB:0]==63)
                                            write_protect = 1'b1;
                                        else
                                            write_protect = 1'b0;
                                    3'b011:
                                        if((Address[15:12]>=4'hc || (Address[15] == 1'b1 && BE32K_Mode == 1)) && Block[Block_MSB:0]==63)
                                            write_protect = 1'b1;
                                        else
                                            write_protect = 1'b0;
                                    3'b100,3'b101,3'b110:
                                        if(Address[15:12]>=4'h8 && Block[Block_MSB:0]==63)
                                            write_protect = 1'b1;
                                        else
                                            write_protect = 1'b0;
                                    3'b111:write_protect = 1'b1;
                    ...
                    if ( SEC == 1'b0 ) begin
                        if(TB==1'b0)begin
                            ...
                            case({BP2,BP1,BP0})
                                3'b000:write_protect = 1'b1;
                                3'b001:
                                    if(Block[Block_MSB:0] >= 1 && Block[Block_MSB:0] <= 63)begin
                                        write_protect = 1'b1;
                                    end
                                    else begin
                                        write_protect = 1'b0;
                                ...
                                3'b010:
                                    if (Block[Block_MSB:0] >= 2 && Block[Block_MSB:0] <= 63) begin
                                        write_protect = 1'b1;
                                    end
                                    else begin
                                        write_protect = 1'b0;
                                ...
                                3'b011:
                                    if (Block[Block_MSB:0] >= 4 && Block[Block_MSB:0] <= 63) begin
                                        write_protect = 1'b1;
                                    end
                                    else begin
                                        write_protect = 1'b0;
                                ...
                                3'b100:
                                    if (Block[Block_MSB:0] >= 8 && Block[Block_MSB:0] <= 63) begin
                                        write_protect = 1'b1;
                                    end
                                    else begin
                                        write_protect = 1'b0;
                                ...
                                3'b101:
                                    if (Block[Block_MSB:0] >= 16 && Block[Block_MSB:0] <= 63) begin
                                        write_protect = 1'b1;
                                    end
                                    else begin
                                        write_protect = 1'b0;
                        ...
                        if(BE64K_Mode == 1)begin                                          
                            ...
                            if(TB==1'b0) begin
                                case({BP2,BP1,BP0})
                                    3'b000:write_protect = 1'b1;
                                    3'b001:
                                        if(Address[21:0]<=22'h3fefff || (Address[21:15] == 7'h7f && BE32K_Mode == 1))
                                            write_protect = 1'b1;
                                        else
                                            write_protect = 1'b0;
                                    3'b010:
                                        if(Address[21:0]<=22'h3fdfff || (Address[21:15] == 7'h7f && BE32K_Mode == 1))
                                            write_protect = 1'b1;
                                        else
                                            write_protect = 1'b0;
                                    3'b011:
                                        if(Address[21:0]<=22'h3fbfff || (Address[21:15] == 7'h7f && BE32K_Mode == 1))
                                            write_protect = 1'b1;
                                        else
                                            write_protect = 1'b0;
                                    3'b100,3'b101,3'b110:
                                        if(Address[21:0]<=22'h3f7fff)
                                            write_protect = 1'b1;
                                        else
                                            write_protect = 1'b0;
                                    3'b111:write_protect = 1'b0;
                                ...
                                case({BP2,BP1,BP0})
                                    3'b000:write_protect = 1'b1;
                                    3'b001:
                                        if(Address[21:0]>=22'h001000 || (Address[21:15] == 7'h00 && BE32K_Mode == 1))
                                            write_protect = 1'b1;
                                        else
                                            write_protect = 1'b0;
                                    3'b010:
                                        if(Address[21:0]>=22'h002000 || (Address[21:15] == 7'h00 && BE32K_Mode == 1))
                                            write_protect = 1'b1;
                                        else
                                            write_protect = 1'b0;
                                    3'b011:
                                        if(Address[21:0]>=22'h004000 || (Address[21:15] == 7'h00 && BE32K_Mode == 1))
                                            write_protect = 1'b1;
                                        else
                                            write_protect = 1'b0;
                                    3'b100,3'b101,3'b110:
                                        if(Address[21:0]>=22'h008000)
                                            write_protect = 1'b1;
                                        else
                                            write_protect = 1'b0;
                                    3'b111:write_protect = 1'b0;
